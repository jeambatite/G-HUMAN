...
namespace GHumanAPI.Services
{
    public interface IEmpleadoService
    {
        ...
        Task<ResultadoPaginadoDTO<EmpleadoDTO>> GetAllPaginado(int pagina, int tamanoPagina, string? nombre = null, string? rol = null, string? estado = null, string? departamento = null);
    }
}